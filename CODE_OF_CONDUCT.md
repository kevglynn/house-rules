...
Report conduct issues to the kit maintainers — open an issue in this repo or contact the maintainer directly. Teams adopting the kit should substitute their own escalation path when they copy this file.
...
- **Enforcement contact**: Kit maintainers (repo issues or direct contact)
- **Rate limits**: As defined in the upstream Agentic Covenant defaults (3 open PRs per principal, 5/day)
- **Scope**: All kit community spaces — this repository (issues, PRs, discussions)
