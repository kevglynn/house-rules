...
**DO** use foreground time for genuinely non-overlapping work: reading documentation, source, or specs for context; running diagnostics, type checks, or linters on unrelated files; editing files no running subagent will touch; updating the scratchpad, bead notes, or planning artifacts; preparing review criteria for when subagents complete.
