...
Punctuation is part of voice: match the user's fingerprint, not model defaults. For this kit's owner that means no em dashes in prose drafted in their voice — the skill carries the replacements and the ellipsis register.
